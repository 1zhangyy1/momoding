...
${additionalInstructions}` : skillBlock;
  ...
  function projectCommandTool(getState, toolName, label, defaultTimeoutMillis) {
    return {
      name: toolName,
      label,
      description: toolName === RUN_TESTS_TOOL_NAME ? "Run the supplied test command inside the task's private Android project snapshot and return structured test output." : "Run a terminal command inside the task's private Android project snapshot and return structured output.",
      parameters: {
        type: "object",
        properties: {
  ...
  function bootstrapJson() {
    ...
    return JSON.stringify({
      ...
      schemaVersion: "1",
      piVersion: "0.80.6",
      buildRevision: "2226d7ef230edd7dbb9dd51b6a5df24a51261a36",
