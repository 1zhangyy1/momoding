...
export const P1B_DIRECT_PI_EVENT_MAX_BYTES = 1024 * 1024;
export const P1B_CHUNK_MAX_PHYSICAL_FRAME_BYTES = 768 * 1024;
export const P1B_CHUNK_MAX_TRANSFER_BYTES = 64 * 1024 * 1024;
export const P1B_CHUNK_MAX_COUNT = 256;
export const P1B_CHUNK_TIMEOUT_MS = 30_000;
