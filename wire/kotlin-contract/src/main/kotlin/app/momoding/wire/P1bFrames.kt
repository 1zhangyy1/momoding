...
/**
 * Complete Host-to-client P1B Wire union.
 *
 * P1A frames extend this interface without changing their public P1A decoder.
 ...
 */
sealed interface P1bServerFrame

class ReceivedP1bServerFrame(
    val frame: P1bServerFrame,
    rawBytes: ByteArray,
) {
...
sealed interface TransportChunkStartFrame : P1bServerFrame {
    val protocolVersion: Int
    val kind: String
